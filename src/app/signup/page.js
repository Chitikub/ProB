  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        footer:
          '<div style="font-size:0.8rem; color:#94a3b8;">Technical details hidden</div>',
        showCancelButton: true,
    ...
    <main style={mainBgStyle}>
      ...
      <div className={isVisible ? "page-fade" : ""} style={containerStyle}>
        ...
        <div style={{ ...toggleContainerStyle, margin: "0 auto" }}>
          ...
          <div
            onClick={() => handleSwitchPage("/login")}
            style={{ ...toggleTextStyle, color: "#9ca3af", cursor: "pointer" }}
          >
            เข้าสู่ระบบ
          </div>
        </div>
        ...
        <div style={dividerStyle}>
          ...
          <span
            style={{ padding: "0 15px", color: "#cbd5e1", fontSize: "0.8rem" }}
          >
            ระบุข้อมูลของคุณ
          </span>
          <div style={lineStyle}></div>
        ...
        <form
          ...
          style={{ ...formWrapperStyle, margin: "0 auto" }}
        >
          <div style={inputGroupStyle}>
            ...
            <div
              ...
              style={{
                ...inputContainerStyle,
                borderColor: errors.firstName ? "#EF4444" : "#f1f5f9",
              }}
            >
          ...
          <div style={inputGroupStyle}>
            ...
            <div
              ...
              style={{
                ...inputContainerStyle,
                borderColor: errors.lastName ? "#EF4444" : "#f1f5f9",
              }}
            >
              <span style={{ marginRight: "10px" }}>📛</span>
              <input
          ...
          <div style={inputGroupStyle}>
            ...
            <div
              ...
              style={{
                ...inputContainerStyle,
                borderColor: errors.email ? "#EF4444" : "#f1f5f9",
              }}
            >
              <span style={{ marginRight: "10px" }}>📧</span>
              <input
          ...
          <div style={inputGroupStyle}>
            ...
            <div
              ...
              style={{
                ...inputContainerStyle,
                borderColor: errors.password ? "#EF4444" : "#f1f5f9",
              }}
            >
              <span style={{ marginRight: "10px" }}>🔒</span>
              <input
          ...
          >
              ...
              style={{
                ...
                boxShadow:
                  formData.gender === "male"
                    ...
                    : "0 6px 15px rgba(244, 114, 182, 0.35)",
              }}
            ></div>
            <div
              ...
              style={{
                ...toggleTextStyle,
                color: formData.gender === "male" ? "#fff" : "#94a3b8",
                cursor: "pointer",
              }}
            >
              ชาย
            ...
            <div
              ...
              style={{
                ...toggleTextStyle,
                color: formData.gender === "female" ? "#fff" : "#94a3b8",
                cursor: "pointer",
              }}
            >
              หญิง
...
const mainBgStyle = {
  ...
  backgroundImage:
    "radial-gradient(at 0% 0%, rgba(226, 209, 249, 0.2) 0, transparent 50%), radial-gradient(at 100% 100%, rgba(192, 132, 252, 0.05) 0, transparent 50%)",
